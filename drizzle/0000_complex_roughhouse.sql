CREATE TYPE "public"."patients_gender" AS ENUM('male', 'female');--> statement-breakpoint
...
CREATE TABLE "doctors" (
	...
	"available_from_week_days" integer NOT NULL,
	"available_to_week_days" integer NOT NULL,
	"available_from_time" time NOT NULL,
	"available_to_time" time NOT NULL,
	"appointments_in_cents" integer NOT NULL,
	"create_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
CREATE TABLE "patients" (
	...
	"email" text NOT NULL,
	"phone" text NOT NULL,
	"gender" "patients_gender" NOT NULL,
	"clinic_id" uuid NOT NULL,
	"create_at" timestamp DEFAULT now() NOT NULL,
